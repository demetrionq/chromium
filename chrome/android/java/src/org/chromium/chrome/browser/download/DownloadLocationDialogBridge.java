...
public class DownloadLocationDialogBridge implements ModalDialogProperties.Controller {
    ...
    private boolean downloadWithAdm(WindowAndroid windowAndroid, long totalBytes,
        ...
        if (useAdmIfPossible && !TextUtils.isEmpty(activeDownloadManagerPackageName) && !TextUtils.isEmpty(activeDownloadManagerActivityName) && activeDownloadManagerPackageName.equals("org.chromium.chrome") != true //com.kiwibrowser.browser
